package com.aragoj.opencv.calibration.ui.custom;
...
public class JFXRadioButtonSkin extends RadioButtonSkin {
    ...
    private double labelOffset = -3;

    public JFXRadioButtonSkin(JFXRadioButton control) {
        super(control);

        final double radioRadius = 6;
        ...
        rippler = new JFXRippler(boxContainer, JFXRippler.RipplerMask.CIRCLE);
