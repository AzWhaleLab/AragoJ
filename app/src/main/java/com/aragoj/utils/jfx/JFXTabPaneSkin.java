...
//            tabContentHolder.relocate(contentStartX, contentStartY);
    ...
    protected class HeaderContainer extends StackPane {
        ...
        public HeaderContainer() {
                ...
                protected void layoutChildren() {
                    if (isTabsFitHeaderWidth()) {
                        ...
                        if (!removedTabsHeaders.isEmpty()) {
                            double offset = 0;
                            double w = header.getWidth() - snappedLeftInset() - SPACER;
            ...
            getChildren().addAll(headerBackground, headersRegion);
...
//            controlPrefWidth = controlPrefWidth > 0 ? controlPrefWidth + SPACER : controlPrefWidth;
            ...
            final double maxWidth = snapSize(getWidth()) - clipOffset;
        ...
        private boolean isTabsFitHeaderWidth() {
            ...
            double visibleWidth = headerPrefWidth+ snappedLeftInset() + SPACER;
        ...
        public void updateScrollOffset(double newOffset) {
            ...
            double visibleWidth = tabPaneWidth - snappedLeftInset() - SPACER;
        ...
        protected void layoutChildren() {
            ...
            switch (side) {
                case TOP:
                    ...
                    controlStartX = w + leftInset;
                    controlStartY = snapSize(getHeight()) - bottomInset;
                    break;
                case BOTTOM:
                    ...
                    controlStartY = snapSize(getHeight()) - topInset;
                    break;
                case LEFT:
                    ...
                    controlStartY = snapSize(getHeight()) - rightInset;
                    break;
                case RIGHT:
                    startX = topInset;
                    startY = tabBackgroundHeight - headersPrefHeight - leftInset;
                    controlStartX = w + topInset;
                    controlStartY = snapSize(getHeight()) - leftInset;
                    break;
            }
            ...
            positionInArea(headersRegion,
                startX  * ((side == Side.LEFT || side == Side.BOTTOM) ? -1 : 1),
