...
/**
 * A somewhat hackish way to accomplish pixelated image views in JavaFX. Should be refactored later
 * if JavaFX devs decide to give a more sane and approachable way.
 * <p>
 * See: https://stackoverflow.com/a/39294505
 */
@SuppressWarnings("restriction") public class PixelatedImageView extends ImageView {
